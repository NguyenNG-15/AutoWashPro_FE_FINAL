                            ...
                            <td className="px-6 py-4">
                              <div className="flex items-center gap-2">
                                {booking.nextAction ? (
                                  ...
                                  <span className="text-[#848a9c] flex-1 text-center">—</span>
                                )}
                                <button
                                  type="button"
                                  onClick={(e) => handleDeleteBooking(e, booking)}
                                  disabled={actingId === booking.id}
                                  className="p-1.5 text-red-500 hover:text-red-700 hover:bg-red-50 rounded transition-colors disabled:opacity-60"
